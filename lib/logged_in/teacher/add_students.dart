      ...
      body: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Center(child: Text(_message, style: GoogleFonts.roboto(color: Colors.red),)),
            Expanded(
              child: Padding(
                    ...
                    return Card(
                      ...
                      child: Container(
                        ...
                        child: ListTile(
                          ...
                          title: Row(
                            children: <Widget>[
                              Expanded(child: Text('${_filteredStudents[index]}', style: GoogleFonts.roboto(color: Colors.cyan),)),
