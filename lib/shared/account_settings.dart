                  ...
                  Container(
                    ...
                    child: Row(
                      children: <Widget>[
                        ...
                        Expanded(child: Text(
                          'Account Settings', style: GoogleFonts.roboto(color: Colors
                  ...
                  children: <Widget>[
                    ...
                    Card(
                      child: ListTile(
                        ...
                        subtitle: _status['index'] == 0 ? Text(
                          _status['status'],
                          style: GoogleFonts.roboto(color: _status['error']
                              ? Colors.red
                              : Colors.green),) : Text(
                    ...
                    Card(
                      child: ListTile(
                        ...
                        subtitle: _status['index'] == 2 ? Text(
                          _status['status'], style: GoogleFonts.roboto(
                    ...
                    Card(
                      child: ListTile(
                        ...
                        subtitle: Text("DEBUG YOUR APP SETTINGS"),
                        onTap: () {
                         // bleConnections().getPermissions();
                          bleConnections().advertisement(Provider.of<FirebaseUser>(context,listen: false).email);
                          //bleConnections().discovery(Provider.of<FirebaseUser>(context,listen: false).email);
                        },
                      ),
                      shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(10.0)),
                ...
                Expanded(
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text("Update", style: GoogleFonts.roboto(color: Colors
                            .white,
                            fontWeight: FontWeight.bold,
                            letterSpacing: 1.5,
                            fontSize: 17),),
                ...
                Expanded(
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text("Cancel", style: GoogleFonts.roboto(color: Colors
                            .white,
                            fontWeight: FontWeight.bold,
                            letterSpacing: 1.5,
                            fontSize: 17),),
